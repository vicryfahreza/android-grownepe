...
@Composable
fun NaturalHybridScreen(
    modifier: Modifier = Modifier,
    viewModel: NaturalHybridViewModel = viewModel(
...
@Composable
fun NaturalHybridContent(
    state: List<StateNaturalHybrid>,
    navigateToDetail: (Long) -> Unit,
    modifier: Modifier = Modifier,
    viewModel: NaturalHybridViewModel
) {
    Box {
        Column {
